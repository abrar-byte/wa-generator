...
export default function PreviewMessage({
  ...
  return (
    ...
    >
      <div className="lg:w-96 border flex flex-col h-[70vh]">
        {/* <!-- Header --> */}
        <div className="py-2 px-3 bg-gray-200 flex flex-row justify-between items-center">
          <div className="flex items-center">
            ...
            <div className="ml-4 overflow-x-scroll w-min">
              <p className="text-gray-400">Message to {phone} </p>
            </div>
          </div>
            ...
            <div className="flex mb-2">
              ...
              >
                <p className="text-sm text-teal">
                  This is your preview message
                </p>
                <p className="text-sm mt-1">
                  a preview of the message will appear below here
                </p>
